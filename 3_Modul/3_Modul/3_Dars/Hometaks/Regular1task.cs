...
namespace _3_Modul._3_Dars.Hometaks
{
    internal class Regular1task
    {
        ...
        //  Console.Write("Enter character which exists between a-g ? : ");
        ////  Console.WriteLine(Regex.IsMatch(InputString, "[a-g]"));
        ////  Console.WriteLine(Regex.IsMatch(InputString,"[a-d]"));
        //string[] names = { "Ortiq", "ortiq", "Ortiq1","Ortiq", "Sardor", "Abdulatif1", "Diyorbek", "Jaxon", "Elyor","Sarvar" };
        ...
        // }
        //string pattern = "Ortiqbek";
        //Regex regex = new Regex(pattern);
        //Console.WriteLine("Ortiq Murodov :"+Regex.IsMatch("Murodov Ortiq",pattern));
        //Console.WriteLine("I am Murodov Ortiq :"+Regex.IsMatch("Murodov ",pattern));
        //Console.WriteLine("Ortiq :"+Regex.IsMatch("Ortiq ",pattern));
        //Console.WriteLine("True or False :" + Regex.IsMatch("Ortiqbek", pattern));
